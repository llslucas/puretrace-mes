...
- **Exemplo:** A regra de que _"o desperdício não pode exceder 10%"_ não é uma validação no Controller ou Service. Ela pertence à entidade `ProductionOrderModel`. É impossível instanciar uma ordem inválida no sistema.
...
- **Tests** [Jest](https://jestjs.io/) + [TestContainers](https://testcontainers.com/) + [EventSource](https://github.com/EventSource/eventsource)
